...
x_data = pd.read_excel('潜在特征2.xls', na_values = missing_values)  # 加载数据
...
#fit执行训练过程
history = model.fit(x_train, y_train, batch_size=512, epochs=2000, validation_data=(x_test, y_test), validation_freq=1)
...
pred.to_excel('45市经济损失预测值第3组.xls')
